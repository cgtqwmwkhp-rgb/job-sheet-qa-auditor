...
export interface EvalReport {
  ...
  /**
   * True when results were synthesized from fixtures rather than observed from
   * the live evaluation collector. Simulated runs must not satisfy accuracy
   * gates or be presented as production accuracy.
   */
  simulated: boolean;
...
export const DEFAULT_EVAL_CONFIG: EvalConfig = {
  ...
  weights: {
    selectionAccuracy: 0.3,
    criticalFieldAccuracy: 0.4,
    fusionAgreement: 0.2,
    pass2Rate: 0.1,
  },
  alertThresholds: {
    selectionAccuracyMin: 0.95,
    criticalFieldAccuracyMin: 0.9,
