...
test.describe("Demo Gateway UI", () => {
  ...
  test("should display Technician card with correct features", async ({
    page,
  }) => {
    // Close onboarding first
    await page.keyboard.press("Escape");
  ...
  test("should set localStorage when clicking Technician card", async ({
    page,
  }) => {
    // Close onboarding first
    await page.keyboard.press("Escape");
...
test.describe("Demo Mode Navigation", () => {
  ...
  test("should redirect to technician portal for technician role", async ({
    page,
  }) => {
    // Set technician role
    await page.evaluate(() => {
