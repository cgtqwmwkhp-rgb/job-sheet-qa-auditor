...
const BATCH_4_TEMPLATES = [
    ...
    fixtures: [
      {
        ...
        inputText:
          "Generator service backup power job reference GEN-123 asset id GEN-001 date 2024-01-15 engineer sign off complete",
    ...
    fixtures: [
      {
        ...
        description: "Complete",
        inputText:
          "Security alarm intruder testing job reference SEC-123 asset id ALARM-001 date 2024-01-15 expiry date 2025-01-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
    ...
    fixtures: [
      {
        ...
        description: "Complete",
        inputText:
          "Access control door keycard job reference ACC-123 asset id DOOR-001 date 2024-01-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
  },
  {
    ...
    fixtures: [
      {
        caseId: "CCTV-PASS-001",
        description: "Complete",
        inputText:
          "CCTV camera surveillance maintenance job reference CCTV-123 asset id CAM-001 date 2024-01-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
  },
  {
    ...
    fixtures: [
      {
        caseId: "DUCT-PASS-001",
        description: "Complete",
        inputText:
          "Duct cleaning hygiene certification job reference DUCT-123 asset id AHU-001 date 2024-01-15 expiry date 2025-01-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
...
describe("Template Batch 4 Onboarding - PR-R Contract Tests", () => {
  ...
  describe("Selection Token Uniqueness (Collision Detection)", () => {
    ...
    it("should not collide with any previous batch templates", () => {
      const batch4Tokens = BATCH_4_TEMPLATES.map(
