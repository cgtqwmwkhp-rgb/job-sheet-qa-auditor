  ...
  describe("Trend Calculation", () => {
    it("should calculate trends between runs", () => {
      const current: EvalReport = {
        ...
        selectionMetrics: {
          ...calculateSelectionMetrics(sampleResults),
          accuracy: 0.9,
        },
        criticalFieldMetrics: {
          ...calculateCriticalFieldMetrics(sampleResults),
          criticalOnlyAccuracy: 0.85,
        },
        fusionMetrics: {
          ...calculateFusionMetrics(sampleResults),
          agreementRate: 0.88,
        },
        pass2Metrics: {
          ...calculatePass2Metrics(sampleResults),
          pass2Rate: 0.1,
        },
        overallScore: 0.88,
        trends: [],
      ...
      const previous: EvalReport = {
        ...
        criticalFieldMetrics: {
          ...current.criticalFieldMetrics,
          criticalOnlyAccuracy: 0.8,
        },
      ...
      const selectionTrend = trends.find(
        t => t.metric === "selection_accuracy"
      )!;
