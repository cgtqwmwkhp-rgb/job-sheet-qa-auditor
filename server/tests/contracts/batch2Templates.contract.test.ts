...
const BATCH_2_TEMPLATES = [
  {
    ...
    roiJson: {
      regions: [
        ...
        },
        {
          name: "tickboxBlock",
          page: 1,
          bounds: { x: 0.05, y: 0.25, width: 0.9, height: 0.35 },
        },
        {
          name: "signatureBlock",
          page: 1,
    ...
    fixtures: [
      {
        caseId: "HVAC-PASS-001",
        description: "Complete",
        inputText:
          "HVAC service job reference HVAC-123 asset id UNIT-001 date 2024-01-15 engineer sign off complete",
  ...
  },
  {
    ...
    fixtures: [
      {
        caseId: "ELEC-PASS-001",
        description: "Complete",
        inputText:
          "Electrical safety job reference ELEC-555 asset id PROP-123 date 2024-01-15 expiry date 2025-01-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
  },
  {
    ...
    roiJson: {
      regions: [
        ...
        },
        {
          name: "tickboxBlock",
          page: 1,
          bounds: { x: 0.05, y: 0.25, width: 0.9, height: 0.3 },
        },
        {
          name: "signatureBlock",
          page: 1,
    ...
    fixtures: [
      {
        caseId: "PLUMB-PASS-001",
        description: "Complete",
        inputText:
          "Plumbing repair job reference PLUMB-777 asset id HOUSE-456 date 2024-01-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
  },
  {
    ...
    fixtures: [
      {
        caseId: "FIRE-PASS-001",
        description: "Complete",
        inputText:
          "Fire safety job reference FIRE-333 asset id BLDG-789 date 2024-01-15 expiry date 2024-07-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
    ...
    fixtures: [
      {
        ...
        description: "Complete",
        inputText:
          "Gas boiler service job reference GAS-111 asset id BLR-001 date 2024-01-15 expiry date 2025-01-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
...
describe("Template Batch 2 Onboarding - PR-O Contract Tests", () => {
    ...
    it("should create fixture packs for all templates", () => {
      for (const template of BATCH_2_TEMPLATES) {
        ...
        const pack = createFixturePack(
          version.id,
          template.fixtures as FixtureCase[],
          1
        );
  ...
  describe("Determinism", () => {
    it("should produce consistent fixture results across runs", () => {
      ...
      const report1 = runFixtureMatrix(
        version.id,
        template.specJson as SpecJson,
        template.selectionConfig as SelectionConfig
      );
      const report2 = runFixtureMatrix(
        version.id,
        template.specJson as SpecJson,
        template.selectionConfig as SelectionConfig
      );
