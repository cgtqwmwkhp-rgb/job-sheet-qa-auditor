...
describe("ROI Validator - PR-H Contract Tests", () => {
  ...
  describe("ROI Validation", () => {
        ...
        regions: [
          {
            name: "test",
            page: 1,
            bounds: { x: 1.5, y: 0, width: 0.5, height: 0.1 },
          },
        ],
      };
        ...
        regions: [
          {
            name: "test",
            page: 1,
            bounds: { x: -0.1, y: 0, width: 0.5, height: 0.1 },
          },
        ],
      };
        ...
        regions: [
          {
            name: "test",
            page: 1,
            bounds: { x: 0.5, y: 0.5, width: 0, height: 0.1 },
          },
        ],
      };
      ...
      const withDuplicates: RoiConfig = {
        regions: [
          ...
          },
          {
            name: "header",
            page: 1,
            bounds: { x: 0, y: 0.5, width: 1, height: 0.1 },
          },
        ],
      };
        ...
        regions: [
          {
            name: "region1",
            page: 1,
            bounds: { x: 0, y: 0, width: 0.6, height: 0.3 },
          },
          {
            name: "region2",
            page: 1,
            bounds: { x: 0.4, y: 0.1, width: 0.5, height: 0.3 },
          },
        ],
      };
    ...
    it("should warn about non-standard region types", () => {
      ...
      expect(result.warnings.some(w => w.includes("not a standard"))).toBe(
        true
      );
    });
  });
        ...
        regions: [
          {
            name: "test",
            page: 1,
            bounds: { x: -0.1, y: 1.2, width: 2, height: 0.5 },
          },
        ],
      };
        ...
        regions: [
          {
            name: "test",
            page: 1,
            bounds: { x: 0.5, y: 0.5, width: 0, height: 0 },
          },
        ],
      };
  ...
  describe("ROI Persistence", () => {
    ...
    it("should throw error when updating non-existent version", () => {
      expect(() => updateVersionRoi(999, validRoiConfig)).toThrow(
        "Version not found"
      );
    });
  });
