...
const BATCH_3_TEMPLATES = [
  {
    ...
    fixtures: [
      {
        caseId: "LIFT-PASS-001",
        description: "Complete",
        inputText:
          "Lift inspection job reference LIFT-123 asset id ELEV-001 date 2024-01-15 expiry date 2025-01-15 engineer sign off complete",
    ...
    fixtures: [
      {
        ...
        description: "Complete",
        inputText:
          "Legionella water testing job reference LEG-123 asset id TANK-001 date 2024-01-15 expiry date 2025-01-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
    ...
    fixtures: [
      {
        ...
        description: "Complete",
        inputText:
          "PPM preventive maintenance schedule job reference PPM-123 asset id EQUIP-001 date 2024-01-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
    ...
    fixtures: [
      {
        ...
        description: "Complete",
        inputText:
          "Asbestos survey report job reference ASB-123 asset id BLDG-001 date 2024-01-15 expiry date 2025-01-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
  },
  {
    ...
    fixtures: [
      {
        caseId: "ROOF-PASS-001",
        description: "Complete",
        inputText:
          "Roof inspection survey job reference ROOF-123 asset id BLDG-002 date 2024-01-15 engineer sign off complete",
        expectedOutcome: "pass" as const,
        required: true,
      },
    ],
...
describe("Template Batch 3 Onboarding - PR-Q Contract Tests", () => {
  ...
  describe("Selection Token Uniqueness (Ambiguity Review)", () => {
    ...
    it("should not collide with batch 2 templates", () => {
      ...
      const batch3Tokens = BATCH_3_TEMPLATES.map(
        t => t.selectionConfig.requiredTokensAll
      );
      ...
      for (const b3 of batch3Tokens) {
        for (const b2 of batch2Tokens) {
          ...
          const identical =
            b3.length === b2.length && b3.every(t => b2Set.has(t));
