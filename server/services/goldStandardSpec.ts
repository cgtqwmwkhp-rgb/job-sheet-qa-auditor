...
export const GOLD_STANDARD_SPEC_V1: GoldStandardSpec = {
  ...
  description:
    "Enterprise specification for validating job sheets, repair reports, and compliance documents",
  documentTypes: [
    "Repair Report",
    "Compliance Report",
    "Service Report",
  ...
  fields: [
    // ========== ASSET INFORMATION (Category) ==========
    {
      ...
      whyItMatters:
        "Critical for asset tracking, maintenance history, and warranty claims. Without this, the work cannot be attributed to the correct equipment.",
      validationRules: [
    ...
    },
    {
      ...
      whyItMatters:
        "Essential for parts ordering, technical documentation lookup, and warranty verification.",
      validationRules: [createPresenceRule("Make/Model")],
    },
    {
      id: "serial_no",
      name: "Serial Number",
      ...
      whyItMatters:
        "Required for warranty claims and manufacturer support cases.",
      validationRules: [],
    },
    {
      id: "mileage_hours",
      ...
      whyItMatters:
        "Tracks equipment usage for preventive maintenance scheduling.",
      validationRules: [createRangeRule("Mileage/Hours", 0, 10000000)],
    },
    ...
    // ========== JOB INFORMATION (Category) ==========
    {
      ...
      whyItMatters:
        "Primary key for billing, scheduling, and audit trail. Required for invoicing and dispute resolution.",
      validationRules: [
    ...
    },
    {
      ...
      whyItMatters:
        "Required for billing, customer communication, and contract compliance.",
      validationRules: [createPresenceRule("Customer Name")],
    },
    {
      id: "date",
      name: "Service Date",
      ...
      whyItMatters:
        "Critical for warranty calculations, SLA compliance, and billing accuracy.",
      validationRules: [
    ...
    },
    {
      ...
      whyItMatters:
        "Required for accountability, quality tracking, and competency verification.",
      validationRules: [createPresenceRule("Engineer Name")],
    },
    {
      id: "contact_name",
      name: "Contact Name",
      ...
      whyItMatters:
        "Useful for follow-up communication and access arrangements.",
      validationRules: [],
    },
    {
      id: "address",
      ...
      whyItMatters:
        "Required for travel time verification and future site visits.",
      validationRules: [],
    },
    {
      id: "travel_time",
      ...
      validationRules: [createRangeRule("Travel Time", 0, 24)],
    },
    ...
    // ========== ISSUE & WORK DESCRIPTION (Category) ==========
    {
      ...
      whyItMatters:
        "Documents the original complaint for root cause analysis and prevents repeat visits.",
      validationRules: [createPresenceRule("Issue Description")],
    },
    {
      ...
      whyItMatters:
        "Primary evidence of work done. Critical for quality assurance and dispute resolution.",
      validationRules: [
        createPresenceRule("Engineer Comments"),
        {
          ...
          errorMessage:
            "Engineer comments are too brief. Please provide detailed work description.",
    ...
    },
    {
      ...
      whyItMatters:
        "Enables trend analysis and preventive maintenance planning.",
      validationRules: [
        createEnumRule("Fault Reason", [
          "Wear & Tear",
          "Routine",
          "Damage",
          "Electrical",
    ...
    },
    {
      ...
      validationRules: [createRangeRule("Repair Duration", 0, 100)],
    },
    ...
    // ========== PARTS & MATERIALS (Category) ==========
    {
      ...
      whyItMatters:
        "Required for inventory management, billing, and warranty tracking.",
      validationRules: [],
    },
    {
      id: "parts_required",
    ...
    // ========== COMPLETION STATUS (Category) ==========
    {
      ...
      whyItMatters:
        "Determines if the job can be closed or requires follow-up.",
      validationRules: [createPresenceRule("Works Completed")],
    },
    {
      ...
      validationRules: [createPresenceRule("Return Visit Required")],
    },
    {
      id: "safe_to_use",
      name: "Safe to Use",
      ...
      whyItMatters:
        "CRITICAL SAFETY FIELD. Determines VOR (Vehicle Off Road) status. Liability implications.",
      validationRules: [createPresenceRule("Safe to Use")],
    },
    {
      id: "vor_status",
      name: "VOR Status",
      ...
      whyItMatters:
        "Critical for fleet availability tracking and customer SLA compliance.",
      validationRules: [],
    },
    {
      id: "overtime",
    ...
    // ========== SIGNATURES & AUTHORIZATION (Category) ==========
    {
      ...
      whyItMatters:
        "Legal requirement. Confirms engineer accountability and work authorization.",
      validationRules: [createPresenceRule("Technician Signature")],
    },
  ],
  ...
  businessRules: [
    {
      ...
      errorMessage:
        "Inconsistency: Asset marked as VOR but also marked as safe to use",
      whyItMatters:
        "Safety critical. VOR assets must not be flagged as safe to prevent accidents.",
    },
    {
      ...
      severity: "S2",
      description:
        "If parts are still required, return visit should typically be required",
      condition: fields => {
        if (
          fields.parts_required &&
          fields.parts_required.length > 0 &&
          fields.return_visit_required === false
        ) {
          return false;
        }
        return true;
      ...
      errorMessage:
        "Warning: Parts still required but no return visit scheduled",
      whyItMatters:
        "Ensures follow-up is scheduled when parts need to be fitted.",
    },
    {
      ...
      severity: "S1",
      description:
        "If work is not fully completed, return visit should be required",
      condition: fields => {
        if (
          fields.works_completed === false &&
          fields.return_visit_required === false
        ) {
          return false;
        }
      ...
      whyItMatters:
        "Prevents jobs being closed prematurely without resolution.",
    },
    {
      id: "unsafe_asset_vor",
      ...
      whyItMatters:
        "Ensures unsafe equipment is properly flagged for fleet management.",
    },
    {
      ...
      whyItMatters:
        "Detailed comments are essential for quality assurance and knowledge transfer.",
    },
  ],
};
...
export function validateAgainstGoldStandard(
  ...
  const foundRequired = fieldResults.filter(
    f => f.isRequired && f.isPresent
  ).length;
  ...
  const businessRuleScore =
    (passedBusinessRules / spec.businessRules.length) * 10;

  const overallScore = Math.round(
    fieldScore + requiredScore + businessRuleScore
  );
