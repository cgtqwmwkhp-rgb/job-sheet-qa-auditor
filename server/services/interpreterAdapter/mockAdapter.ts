...
const MOCK_INSIGHTS: Insight[] = [
  {
    ...
    description:
      "The date field uses a non-standard format that may benefit from manual verification.",
    affectedFields: ["date"],
    confidence: 0.75,
  ...
  },
  {
    ...
    description:
      "Some optional fields could be populated for better record completeness.",
    affectedFields: ["notes", "attachments"],
    confidence: 0.6,
    reasoning:
      "Optional fields are empty but could provide additional context.",
  },
];
