                ...
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="item-2">
                    ...
                    <AccordionContent className="text-muted-foreground">
                      ...
                      flags it for manual review in the "Hold Queue". A QA Lead
                      can then verify the value. If it's a persistent issue,
                      engineers can raise a dispute which you can resolve in the
                  ...
                  <AccordionItem value="item-4">
                    ...
                    <AccordionContent className="text-muted-foreground">
                      ...
                      semantic content of engineer notes. We score them based on
                      Clarity (is it understandable?), Completeness (does it
                      cover the work done?), and Sentiment (is it
                      professional?).
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <div className="rounded-lg border border-red-200 bg-red-50/50 dark:bg-red-950/20 p-4 space-y-2">
                    ...
                    <p>
                      ...
                      signature, unsafe tread depth) are always Major and cannot
                      be downgraded by non-admin users.
                    </p>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-sm text-muted-foreground">
                <p>
                  ...
                  asset could not be returned to service. When the system
                  detects a VOR flag, it cross-checks the surrounding
                ...
                <div className="grid gap-4 md:grid-cols-2 mt-2">
                  <div className="rounded-lg border border-green-200 bg-green-50/50 dark:bg-green-950/20 p-4">
                    ...
                    <p>
                      ...
                      status, safety flags, and completion fields. This is not
                      an asset pass.
                    </p>
                  </div>
                  <div className="rounded-lg border border-red-200 bg-red-50/50 dark:bg-red-950/20 p-4">
                    ...
                    <p>
                      ...
                      "Safe To Use = Yes", or "All Works Completed = Yes"
