...
export function RoiEditor({
  ...
  return (
    <div className="roi-editor" style={{ fontFamily: "system-ui, sans-serif" }}>
      ...
      >
        <span
          style={{ fontWeight: 600, marginRight: "8px", alignSelf: "center" }}
        >
          Region Type:
        </span>
            ...
            style={{
              ...
              border:
                currentTool === type.id
                  ...
                  : "1px solid #e2e8f0",
              backgroundColor:
                currentTool === type.id ? `${type.color}20` : "white",
                ...
                style={{
                  ...
                  outline:
                    selectedRegion === region.name
                      ? `3px solid ${getRegionColor(region.name)}`
                      : "none",
                  outlineOffset: "2px",
                }}
              >
                ...
                >
                  {STANDARD_ROI_TYPES.find(t => t.id === region.name)?.label ??
                    region.name}
                </span>
              </div>
            ))}
                  ...
                  >
                    <div>
                      ...
                      <span style={{ fontWeight: 500 }}>
                        {STANDARD_ROI_TYPES.find(t => t.id === region.name)
                          ?.label ?? region.name}
                      </span>
                    </div>
                    {!readOnly && (
